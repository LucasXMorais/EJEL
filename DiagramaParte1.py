...
def linha_diagrama(ponto_ini, nmr_circuito, bitola_fio, fases, disjuntor):
    ...
    acad.model.AddText('%s mm²' % bitola_fio, APoint(ponto_ini.x + 215, ponto_ini.y + 15), 10)
...
for i in range(0,total_circ):
    ...
    linha_diagrama(APoint(ponto_ini.x + 60, ponto_ini.y - 90 - 90 * (i+1)), proj_el[i][0], proj_el[i][1], proj_el[i][2], proj_el[i][3])
